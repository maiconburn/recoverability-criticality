...
|---|---|---|
| **The founding question: could a black hole make macroscopic matter quantum?** The layman's hypothesis that started this entire program. | Refuted on day 1 by the first controlled tests; the program pivoted to what the mathematics actually supported (information cost near spectral critical points). Published as dead from the start. | `results/RESULTS.md` |
