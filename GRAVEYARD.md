...
|---|---|---|
| **The founding question: could extreme gravity push macroscopic matter into the quantum regime?** The speculative question that seeded the program, asked before any formalism existed — the mirror image of Penrose's (equally speculative, Nobel-laureate) proposal that gravity collapses quantum states. | The specific testable mechanism extracted from it was refuted on day 1; the program pivoted to what the mathematics supported (information cost near spectral critical points). Published as dead from the start. | `results/RESULTS.md` |
