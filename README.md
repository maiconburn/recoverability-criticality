...
- **EP-pair annihilation at λ_ext = 0.12475 ± 0.00025 — consistent with the exact eikonal threshold λ_GB = 1/8** (Konoplya–Zhidenko). The corrected picture (see `ERRATA.md`): two real EPs bound a narrow ρ-dip that skims zero along an extended near-marginal band λ ∈ [~0.113, 1/8], annihilating at the eikonal-instability boundary — suggesting the annihilation IS the eikonal spectral reorganization seen through EP topology (exactness conjectured, not proven). The EP thus survives the entire causality window (λ ≤ 9/100) and the whole band up to 1/8; the halving law holds unchanged at λ = 0.095, 0.105 *inside the acausal band*
